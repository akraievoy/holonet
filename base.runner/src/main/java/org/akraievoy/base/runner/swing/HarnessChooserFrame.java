...
public class HarnessChooserFrame extends JFrame {
  protected final HarnessChooserPanel rootPanel;

  public HarnessChooserFrame(final HarnessChooserPanel rootPanel) {
  ...
  protected void setup() {
    ...
    rootPanel.getHarnessTable().getSelectionModel().setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
  }
  ...
  public JTable getHarnessTable() {
    return rootPanel.getHarnessTable();
  }
